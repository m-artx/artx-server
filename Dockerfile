...
RUN echo "distributionBase=GRADLE_USER_HOME\distributionPath=wrapper/dists\distributionUrl=https\://services.gradle.org/distributions/gradle-7.5.1-bin.zip\zipStoreBase=GRADLE_USER_HOME\zipStorePath=wrapper/dists" > /home/gradle/.gradle/gradle.properties
