...
public class ProductCategoryRead {
	...
	public static class SummaryResponse {
		...
		public static SummaryResponse of(String imagesApiAddress , com.artx.artx.product.entity.ProductCategory productCategory){
			return SummaryResponse.builder()
					...
					.productCategoryRepresentativeImage(Objects.isNull(productCategory.getProductCategoryImage()) ? "" : imagesApiAddress + productCategory.getProductCategoryImage().getRepresentativeImage())
					.build();
		}
	}
