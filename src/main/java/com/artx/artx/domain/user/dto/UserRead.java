	...
	public static class ResponseAll{
		...
		public static ResponseAll of(User user) {
			return ResponseAll.builder()
					...
					.userNickname(user.getNickname())
					.userPhoneNumber(user.getPhoneNumber())
					.userAddress(Objects.isNull(user.getDefaultAddress()) ? "" : user.getDefaultAddress().getAddress().getAddress())
					.userAddressDetail(Objects.isNull(user.getDefaultAddress()) ? "" : user.getDefaultAddress().getAddress().getAddressDetail())
