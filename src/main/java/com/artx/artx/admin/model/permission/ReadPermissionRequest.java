...
public class ReadPermissionRequest {
	...
	public static class Response {
		...
		public static Response from(String imagesApiAddress, PermissionRequest permissionRequest) {
	...
	public static class ResponseAll {
		...
		public static ResponseAll from(String permissionsApiAddress, PermissionRequest permissionRequest) {
